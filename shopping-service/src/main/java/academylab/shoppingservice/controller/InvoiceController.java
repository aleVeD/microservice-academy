package academylab.shoppingservice.controller;

import academylab.shoppingservice.entity.Invoice;
import academylab.shoppingservice.service.InvoiceService;
...
public class InvoiceController {
  ...
  public ResponseEntity<List<Invoice>> listAllInvoices(){
    ...
    if(invoices == null){
      log.error("no se encontraron facturas");
  ...
  public ResponseEntity<Invoice> getInvoice(@PathVariable("id") Long id){
    log.info("fetching invoive with id "+id);
